    ...
    return (
        ...
        >
            ...
            <Link
                ...
                className="flex items-center gap-x-2 bg-white/10 py-2 px-3.5 rounded-full text-white hover:cursor-pointer overflow-hidden transition-colors duration-50 relative z-0 before:block before:absolute before:top-0 before:left-0 before:w-full before:scale-x-0 before:origin-left before:rounded-full before:h-full before:bg-white before:-z-10 before:transition-all before:duration-500 hover:before:scale-x-100 hover:text-black"
                target="_blank"
                title="Github Profile"
            >
                <githubLink.Icon className="size-6" />
